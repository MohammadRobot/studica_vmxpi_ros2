  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
  ...
  {
    // Simulate robot wheels' movement as a first-order system
...
hardware_interface::return_type studica_vmxpi_ros2::RobotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  studica_vmxpi_ros2::RobotSystemHardware, hardware_interface::SystemInterface)
