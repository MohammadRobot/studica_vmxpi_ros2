...
"""Private Orbbec camera launch with optional static TF configuration."""
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "orbbec_enable_color",
            default_value="false",
            description="Enable color streaming; false preserves hardware thermal headroom.",
        ),
        DeclareLaunchArgument(
            "orbbec_enable_depth",
            default_value="true",
            description="Enable depth streaming.",
        ),
        DeclareLaunchArgument(
            "orbbec_enable_ir",
            default_value="false",
        ...
        DeclareLaunchArgument(
            "orbbec_color_width",
            default_value="640",
            description="Color width used when color streaming is enabled.",
        ),
        DeclareLaunchArgument(
            "orbbec_color_height",
            default_value="480",
            description="Color height used when color streaming is enabled.",
        ),
        DeclareLaunchArgument(
            "orbbec_color_fps",
            default_value="15",
            description="Color frame rate used when color streaming is enabled.",
        ),
        DeclareLaunchArgument(
            "orbbec_depth_width",
            default_value="320",
            description="Depth width; 320 is the VMXPi low-load default.",
        ),
        DeclareLaunchArgument(
            "orbbec_depth_height",
            default_value="240",
            description="Depth height; 240 is the VMXPi low-load default.",
        ),
        DeclareLaunchArgument(
            "orbbec_depth_fps",
            default_value="5",
            description="Depth frame rate; 5 Hz is the VMXPi low-load default.",
        ),
        DeclareLaunchArgument(
